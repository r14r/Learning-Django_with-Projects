...
**Level:** Expert  
**Project:** 10_api_gateway  
**Description:** Rate limiting, JWT auth and request routing

---

## 1. Overview

Rate limiting, JWT auth and request routing. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
