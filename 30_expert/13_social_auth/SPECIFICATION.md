# Specification: Social Authentication

**Level:** Expert  
**Project:** 13_social_auth  
**Description:** OAuth2 social login with django-allauth

---

## 1. Overview

OAuth2 social login with django-allauth. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
