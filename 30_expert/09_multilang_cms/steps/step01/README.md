...
python manage.py startapp multilang_cms
```
...
from multilang_cms import views
...
Open http://127.0.0.1:8000/ — you should see "Welcome to Multi-Language CMS!"
