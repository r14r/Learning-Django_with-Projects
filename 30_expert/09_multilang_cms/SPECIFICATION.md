# Specification: Multi-Language CMS

**Level:** Expert  
**Project:** 09_multilang_cms  
**Description:** Content management with i18n and django-parler

---

## 1. Overview

Content management with i18n and django-parler. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
