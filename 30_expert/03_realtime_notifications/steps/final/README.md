...
## What this is
This is the **complete, fully-integrated application** for **Real-Time Notifications**.
...
## Files included
  ...
  - `config/settings.py`
  - `config/urls.py`
  - `realtime_notifications/admin.py`
  - `realtime_notifications/forms.py`
  - `realtime_notifications/models.py`
  - `realtime_notifications/tests.py`
  - `realtime_notifications/urls.py`
  - `realtime_notifications/views.py`
