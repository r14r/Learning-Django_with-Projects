...
## What this is
This is the **complete, fully-integrated application** for **Full-Stack with React**.
...
## Files included
  ...
  - `config/settings.py`
  - `config/urls.py`
  - `fullstack_react/admin.py`
  - `fullstack_react/forms.py`
  - `fullstack_react/models.py`
  - `fullstack_react/tests.py`
