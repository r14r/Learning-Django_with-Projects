...
## What this is
This is the **complete, fully-integrated application** for **Docker & Kubernetes Deploy**.
...
## Files included
  ...
  - `config/settings.py`
  - `config/urls.py`
  - `docker_deployment/admin.py`
  - `docker_deployment/forms.py`
  - `docker_deployment/models.py`
  - `docker_deployment/tests.py`
