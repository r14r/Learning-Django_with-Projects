# Specification: Distributed Task Queue

**Level:** Expert  
**Project:** 08_celery_tasks  
**Description:** Background tasks with Celery, Redis and Flower

---

## 1. Overview

Background tasks with Celery, Redis and Flower. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
