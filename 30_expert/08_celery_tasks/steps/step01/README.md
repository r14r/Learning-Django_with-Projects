...
def home(request):
    return HttpResponse('<h1>Welcome to Distributed Task Queue!</h1>')
```
...
Open http://127.0.0.1:8000/ — you should see "Welcome to Distributed Task Queue!"
