# Specification: Full-Text Search Engine

**Level:** Expert  
**Project:** 07_search_engine  
**Description:** Elasticsearch integration with django-elasticsearch-dsl

---

## 1. Overview

Elasticsearch integration with django-elasticsearch-dsl. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
