...
Multiple-choice quiz with score tracking. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
