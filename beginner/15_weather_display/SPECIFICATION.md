# Specification: Weather Display

**Level:** Beginner  
**Project:** 15_weather_display  
**Description:** Display weather info fetched from an external API

---

## 1. Overview

Display weather info fetched from an external API. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
