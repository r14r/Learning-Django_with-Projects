...
**Level:** Beginner  
**Project:** 07_contact_form  
**Description:** Form handling, validation and email sending

---

## 1. Overview

Form handling, validation and email sending. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
