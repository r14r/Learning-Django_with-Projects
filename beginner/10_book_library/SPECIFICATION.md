# Specification: Book Library

**Level:** Beginner  
**Project:** 10_book_library  
**Description:** Book catalog with search and CRUD operations

---

## 1. Overview

Book catalog with search and CRUD operations. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
