# Specification: Hello Django

**Level:** Beginner  
**Project:** 01_hello_django  
**Description:** Your first Django 'Hello World' web application

---

## 1. Overview

Your first Django 'Hello World' web application. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
