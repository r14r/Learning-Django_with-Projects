...
Create, read, update and delete personal notes. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
