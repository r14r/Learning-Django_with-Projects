...
**Level:** Beginner  
**Project:** 08_user_auth  
**Description:** Registration, login, logout and profile

---

## 1. Overview

Registration, login, logout and profile. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
