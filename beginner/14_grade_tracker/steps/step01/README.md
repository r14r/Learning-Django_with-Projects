...
python manage.py startapp grade_tracker
```
...
from grade_tracker import views
...
Open http://127.0.0.1:8000/ — you should see "Welcome to Grade Tracker!"
