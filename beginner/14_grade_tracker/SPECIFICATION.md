# Specification: Grade Tracker

**Level:** Beginner  
**Project:** 14_grade_tracker  
**Description:** Track student grades and compute averages

---

## 1. Overview

Track student grades and compute averages. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
