...
Create, manage and export PDF invoices. This project teaches fundamental Django concepts appropriate for the **advanced** level including models, views, templates, forms and URL routing.
