...
**Level:** Beginner  
**Project:** 06_temperature_converter  
**Description:** Unit conversion app (°C, °F, Kelvin)

---

## 1. Overview

Unit conversion app (°C, °F, Kelvin). This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
