...
## What this is
This is the **complete, fully-integrated application** for **Temperature Converter**.
...
## Files included
  ...
  - `requirements.txt`
  - `setup.sh`
  - `temperature_converter/admin.py`
  - `temperature_converter/forms.py`
  - `temperature_converter/models.py`
  - `temperature_converter/tests.py`
