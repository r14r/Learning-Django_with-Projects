...
## What this is
This is the **complete, fully-integrated application** for **Personal Portfolio**.
...
## Files included
  ...
  - `config/settings.py`
  - `config/urls.py`
  - `personal_portfolio/admin.py`
  - `personal_portfolio/forms.py`
  - `personal_portfolio/models.py`
  - `personal_portfolio/tests.py`
