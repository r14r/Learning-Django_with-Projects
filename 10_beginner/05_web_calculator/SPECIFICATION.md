# Specification: Web Calculator

**Level:** Beginner  
**Project:** 05_web_calculator  
**Description:** Browser-based arithmetic calculator

---

## 1. Overview

Browser-based arithmetic calculator. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
