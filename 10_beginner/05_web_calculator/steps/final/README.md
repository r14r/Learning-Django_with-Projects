...
## What this is
This is the **complete, fully-integrated application** for **Web Calculator**.
...
## Files included
  ...
  - `setup.sh`
  - `templates/base.html`
  - `web_calculator/admin.py`
  - `web_calculator/forms.py`
  - `web_calculator/models.py`
  - `web_calculator/tests.py`
