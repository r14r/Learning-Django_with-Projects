# Specification: Simple Blog

**Level:** Beginner  
**Project:** 04_simple_blog  
**Description:** Blog with posts, list view and detail view

---

## 1. Overview

Blog with posts, list view and detail view. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
