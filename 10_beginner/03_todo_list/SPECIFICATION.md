...
**Description:** Basic CRUD todo application with models and views

---

## 1. Overview

Basic CRUD todo application with models and views. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
