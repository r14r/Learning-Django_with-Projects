# Specification: URL Shortener

**Level:** Beginner  
**Project:** 12_url_shortener  
**Description:** Shorten long URLs and track click counts

---

## 1. Overview

Shorten long URLs and track click counts. This project teaches fundamental Django concepts appropriate for the **beginner** level including models, views, templates, forms and URL routing.
