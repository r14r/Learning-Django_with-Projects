...
INSTALLED_APPS = [
    ...
    'blog_with_comments',          # ← add your app
]
```
...
def home(request):
    return HttpResponse('<h1>Welcome to Blog with Comments!</h1>')
```
...
Open http://127.0.0.1:8000/ — you should see "Welcome to Blog with Comments!"
