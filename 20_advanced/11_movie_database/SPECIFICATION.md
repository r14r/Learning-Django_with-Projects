...
IMDb-style database with ratings and reviews. This project teaches fundamental Django concepts appropriate for the **advanced** level including models, views, templates, forms and URL routing.
