...
## analytics_dashboard/views.py  (add to existing file)
...
class ItemCreateView(LoginRequiredMixin, CreateView):
    model      = Item
    form_class = ItemForm
    success_url = reverse_lazy('analytics_dashboard:list')
...
## analytics_dashboard/urls.py  (updated)
