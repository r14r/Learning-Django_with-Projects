# Specification: Multi-Tenant SaaS

**Level:** Expert  
**Project:** 02_saas_platform  
**Description:** SaaS with per-tenant schemas using django-tenants

---

## 1. Overview

SaaS with per-tenant schemas using django-tenants. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
