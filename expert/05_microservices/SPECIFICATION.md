...
**Level:** Expert  
**Project:** 05_microservices  
**Description:** Decomposed Django services communicating via REST

---

## 1. Overview

Decomposed Django services communicating via REST. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
