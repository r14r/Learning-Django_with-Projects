# Specification: Advanced Testing

**Level:** Expert  
**Project:** 15_testing_framework  
**Description:** Full test suite with pytest, factory_boy and coverage

---

## 1. Overview

Full test suite with pytest, factory_boy and coverage. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
