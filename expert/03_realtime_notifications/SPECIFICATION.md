...
**Level:** Expert  
**Project:** 03_realtime_notifications  
**Description:** Push notifications via WebSockets and Channels

---

## 1. Overview

Push notifications via WebSockets and Channels. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
