# Specification: Docker & Kubernetes Deploy

**Level:** Expert  
**Project:** 14_docker_deployment  
**Description:** Containerised Django app deployed to Kubernetes

---

## 1. Overview

Containerised Django app deployed to Kubernetes. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
