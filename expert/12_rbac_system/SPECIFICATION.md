...
**Level:** Expert  
**Project:** 12_rbac_system  
**Description:** Fine-grained permissions with django-guardian

---

## 1. Overview

Fine-grained permissions with django-guardian. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
