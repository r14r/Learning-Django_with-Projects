# Specification: Full E-Commerce Platform

**Level:** Expert  
**Project:** 01_ecommerce_platform  
**Description:** Complete shop with Stripe payments and inventory

---

## 1. Overview

Complete shop with Stripe payments and inventory. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
