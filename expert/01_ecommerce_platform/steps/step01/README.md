...
python manage.py startapp ecommerce_platform
```
...
INSTALLED_APPS = [
    ...
    'ecommerce_platform',          # ← add your app
]
```
...
Open http://127.0.0.1:8000/ — you should see "Welcome to Full E-Commerce Platform!"
