# Specification: ML Model Integration

**Level:** Expert  
**Project:** 06_ml_integration  
**Description:** Serve a scikit-learn / PyTorch model through Django

---

## 1. Overview

Serve a scikit-learn / PyTorch model through Django. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
