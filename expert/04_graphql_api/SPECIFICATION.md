# Specification: GraphQL API

**Level:** Expert  
**Project:** 04_graphql_api  
**Description:** GraphQL endpoint using Graphene-Django

---

## 1. Overview

GraphQL endpoint using Graphene-Django. This project teaches fundamental Django concepts appropriate for the **expert** level including models, views, templates, forms and URL routing.
